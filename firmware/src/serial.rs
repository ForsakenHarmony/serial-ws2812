...
use futures::future;
use serial_ws2812_shared::{BYTES_PER_LED, DEVICE_ERROR_MESSAGE, DEVICE_OK_MESSAGE, DEVICE_PARTIAL_MESSAGE, DEVICE_PRODUCT_NAME, MAX_BUFFER_SIZE, MAX_LEDS_PER_STRIP, MAX_STRIPS, MESSAGE_NUM_LEN, MESSAGE_TYPE_LEN, SET_LEDS_MESSAGE, SET_STRIPS_MESSAGE, UPDATE_MESSAGE};
